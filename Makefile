...
build-linux-arm:
	...
	BINDGEN_EXTRA_CLANG_ARGS='--sysroot /usr/arm-linux-gnueabi' cargo build --target arm-unknown-linux-gnueabi --lib --release

build-linux-arm64:
	rustup default nightly
	rustup target add aarch64-unknown-linux-gnu
	BINDGEN_EXTRA_CLANG_ARGS='--sysroot /usr/aarch64-linux-gnu' cargo build --target aarch64-unknown-linux-gnu --lib --release
